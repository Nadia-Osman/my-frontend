...
// Show quiz when a card is clicked
...
function displayQuestion() {
  ...
  if(currentQuestionIndex >= quiz.length) {
    quizCardsContainer.innerHTML = `<h3>Quiz Completed! Your score: ${currentScore} / ${quiz.length}</h3>`;
    return;
  }
  ...
  quizCardsContainer.appendChild(qDiv);
